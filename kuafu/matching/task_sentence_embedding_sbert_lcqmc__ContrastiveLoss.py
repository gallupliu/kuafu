...
# 加载数据集
train_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/LCQMC/train.txt'), batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
valid_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/LCQMC/dev.txt'), batch_size=batch_size, collate_fn=collate_fn)
test_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/LCQMC/test.txt'), batch_size=batch_size, collate_fn=collate_fn)
