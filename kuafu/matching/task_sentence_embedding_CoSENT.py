...
batch_size = 32
config_path = '/home/gallup/data/bert/bert-base-chinese/config.json'
checkpoint_path = '/home/gallup/data/bert/bert-base-chinese/pytorch_model.bin'
dict_path = '/home/gallup/data/bert/bert-base-chinese/vocab.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/{task_name}/train.txt'), batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
valid_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/{task_name}/dev.txt'), batch_size=batch_size, collate_fn=collate_fn)
test_dataloader = DataLoader(MyDataset(f'/home/gallup/data/corpus/NLP_Datasets/{task_name}/test.txt'), batch_size=batch_size, collate_fn=collate_fn)
