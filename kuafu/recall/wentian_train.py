...
if __name__ == '__main__':
    ...
    # 3. data generator
    train_data = load_data(data_path +'query_doc.csv', skip_header=True, delimiter=",")
    ...
    pre_batch_size = 5000
    corpus = [line[1] for line in csv.reader(open(data_path + "corpus.tsv"), delimiter='\t')]
    query = [line[1] for line in csv.reader(open(data_path + "dev.query.txt"), delimiter='\t')]
